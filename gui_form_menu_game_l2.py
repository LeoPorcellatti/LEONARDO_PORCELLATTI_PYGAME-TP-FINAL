...
class FormGameLevel2(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        # Fondo
        self.static_background = Background(x=0,y=0,width=w,height=h,path="images\locations\space.png")
        ...
        # Jugador
        self.player_1 = Player(x=800,y=400,speed_walk=8,speed_run=16,gravity=8,jump_power=16,frame_rate_ms=120,move_rate_ms=40,jump_height=150, interval_time_jump=300)
        ...
        # Enemigos
        self.enemy_list = []
        self.enemy_list.append (Enemy(x=1000,y=200,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140, lives=1, enemy_type = 1, interval_time_jump=None))
        self.enemy_list.append (Enemy(x=1600,y=400,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140, lives=1, enemy_type = 1, interval_time_jump=None))
        self.enemy_list.append (Enemy(x=400,y=400,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140, lives=1, enemy_type = 1, interval_time_jump=None))

        # Plataformas
        self.plataform_list = []
        self.plataform_list.append(Plataform(x=400, y=450, width=100, height=50,path="images\platforms\plataforma_space.png", speed=5, frame_rate_ms = 150, move_rate_ms=50, type=2)) #MOVE
        self.plataform_list.append(Plataform(x=400, y=300, width=200, height=50, path="images\platforms\plataforma_space.png", speed=0, frame_rate_ms = 150, move_rate_ms=50, type=1)) #izq
        self.plataform_list.append(Plataform(x=0, y=250, width=200, height=50, path="images\platforms\plataforma_space.png", speed=0, frame_rate_ms = 150, move_rate_ms=50, type=1)) #izq
        self.plataform_list.append(Plataform(x=700, y=400, width=400, height=50, path="images\platforms\plataforma_space.png", speed=0, frame_rate_ms = 150, move_rate_ms=50, type=1)) #Medio
        self.plataform_list.append(Plataform(x=1400, y=450, width=100, height=50,path="images\platforms\plataforma_space.png", speed=5, frame_rate_ms = 150, move_rate_ms=50, type=3)) #MOVE
        self.plataform_list.append(Plataform(x=1200, y=300, width=200, height=50, path="images\platforms\plataforma_space.png", speed=0, frame_rate_ms = 150, move_rate_ms=50, type=1)) #Der
        self.plataform_list.append(Plataform(x=1600, y=250, width=200, height=50, path="images\platforms\plataforma_space.png", speed=0, frame_rate_ms = 150, move_rate_ms=50, type=1)) #Der
        ...
        # Botin
        self.botin_list = []
        self.botin_list.append(Botin(x=400, y=525, width=75, height=75, path = "images\\Botin\\botin(0).png", type = 1))
        self.botin_list.append(Botin(x=1700, y=175, width=75, height=75, path = "images\\Botin\\botin(1).png", type = 2))

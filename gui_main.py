...
form_menu_B = FormMenuB(name="form_menu_B",master_surface = screen,x=0,y=0,w=ANCHO_VENTANA,h=ALTO_VENTANA,color_background=(0,255,255),color_border=(255,0,255),active=False, score = None, margen_y = 100, margen_x=10, espacio= 10)

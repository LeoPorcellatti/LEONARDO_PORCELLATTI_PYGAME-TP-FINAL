...
from gui_form_menu_principal_2 import FormMenuPrincipal
from modo import * 
...
form_game_L2 = FormGameLevel2(name="form_game_L1",master_surface = screen,x=0,y=0,w=ANCHO_VENTANA,h=ALTO_VENTANA,color_background=(0,255,255),color_border=(255,0,255),active=False)
